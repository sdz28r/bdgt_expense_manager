    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function getImage() {
                ...
                var imagePath = <?php echo $row_seventh[1]; ?>
                img.src = imagePath;
                var src = document.getElementById("age");
                src.appendChild(img);
            }
            */
                                                        ...
                                                        <div class="form-group form-inline">
                                                            ...
                                                            <span style="float: bottom; color: DodgerBlue;">
                                                                <?php if($row_seventh[1] == ""){
                                                                    ...
                                                                    echo "<div id=\"age\"><a href=\"javascript:getImage();\" target=\"_self\" onclick=\"return getImage();\" style=\"text-decoration:none\">Show bill</a></div>";
                                                                    /* <div id="dialog" title="Basic dialog">
                                                                        <img src="<?php echo "$row_seventh[1]" ?>" alt="Placeholder Image" width="200%" height="150%"/>
                                                                    </div> */
                                                                } ?></span>
                                                            </center>
                                                        </div>
